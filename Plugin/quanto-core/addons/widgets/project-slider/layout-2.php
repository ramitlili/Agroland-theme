<section class="agroland-project-section bg-color-white">
    <div class="container custom-container">
        <div class="row agroland_screenfix_right">
            <div class="col-12 pe-0">
                <div class="swiper agroland-project__slider">
                    <div class="swiper-wrapper">
                        ...
                        ?>
                            <div class="swiper-slide">
                                <div class="agroland-project-box overflow-hidden">
                ...
                <div class="agroland-project__slider-navigation row-padding-top d-flex justify-content-center align-items-center gap-3">
                    <div class="prev-btn">
