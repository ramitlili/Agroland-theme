<section class="agroland-hero5-section bg-color-primary section-padding-bottom">
    ...
    <div class="container custom-container">
        <div class="row g-4 justify-content-between align-items-end">
            <div class="col-lg-8 col-xl-9">
                <div class="agroland-hero5__content move-anim" data-delay="0.45">
            ...
            <div class="col-lg-4 col-xl-3">
                <div class="agroland-hero5__info fade-anim" data-delay="0.60">
                    <p class="word-anim" data-delay="0.60">
                        <?php echo esc_html( $settings['hero_text'] ) ?>
                    </p>
                    <a class="agroland-link-btn btn-pill" href="<?php echo esc_url($settings['button_url']['url']); ?>">
