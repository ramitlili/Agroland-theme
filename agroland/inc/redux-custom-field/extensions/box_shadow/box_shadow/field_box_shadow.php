    ...
    class ReduxFramework_box_shadow extends ReduxFramework_extension_box_shadow
    {
        ...
        public function render()
        {
            ...
            if ($this->field['horizontal'] === true) {
                ...
                echo '<label>' . esc_html__('Offset X', 'quanto') . '</label>';
                echo '<span class="add-on"><i class="el el-resize-horizontal icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-horizontal mini ' . $this->field['class'] . '" placeholder="' . esc_html__('X', 'quanto') . '" rel="' . $this->field['id'] . '-horizontal" value="' . filter_var($this->value['horizontal'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['vertical'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . esc_html__('Offset Y', 'quanto') . '</label>';
                echo '<span class="add-on"><i class="el el-resize-vertical icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-vertical mini ' . $this->field['class'] . '" placeholder="' . __('Y', 'quanto') . '" rel="' . $this->field['id'] . '-vertical" value="' . filter_var($this->value['vertical'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['blur'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . esc_html__('Blur Radius', 'quanto') . '</label>';
                echo '<span class="add-on"><i class="el el-adjust icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-blur mini ' . $this->field['class'] . '" placeholder="' . esc_html__('Blur', 'quanto') . '" rel="' . $this->field['id'] . '-blur" value="' . filter_var($this->value['blur'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['spread'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . esc_html__('Spread Radius', 'quanto') . '</label>';
                echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-spread mini ' . $this->field['class'] . '" placeholder="' . esc_html__('Spread', 'quanto') . '" rel="' . $this->field['id'] . '-spread" value="' . filter_var($this->value['spread'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['opacity'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . esc_html__('Opacity .1 - 1', 'quanto') . '</label>';
                echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-opacity mini ' . $this->field['class'] . '" placeholder="' . esc_html__('Opacity', 'quanto') . '" rel="' . $this->field['id'] . '-opacity" value="' . filter_var($this->value['opacity'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
                echo '<input class="redux-shadow-value shadow-opacity-value" data-id="' . $this->field['id'] . '" type="hidden" id="' . $this->field['id'] . '-opacity" name="' . $this->field['name'] . $this->field['name_suffix'] . '[opacity]' . '" value="' . $this->stripAlphas( $this->value['opacity'] ) . '"></div>';
            }
            ...
            if (isset($this->field['units']) && $this->field['units'] !== false) {
                echo '<div class="shadow-units" original-title="' . esc_html__('Units', 'quanto') . '">';
                echo '<label>' . esc_html__('Units', 'quanto') . '</label>';
                echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . esc_html__('Units', 'quanto') . '" class="redux-shadow redux-shadow-units select ' . $this->field['class'] . '" original-title="' . esc_html__('Units', 'quanto') . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '">';
            ...
            if ($this->field['shadow-color'] === true) {
                ...
                echo '<div class="shadow-color" original-title="' . esc_html__('Shadow Color', 'quanto') . '">';
                echo '<label>' . esc_html__('Shadow Color', 'quanto') . '</label>';
            ...
            if ($this->field['shadow-type'] === true) {
                ...
                echo '<div class="shadow-type" original-title="' . esc_html__('Shadow Type', 'quanto') . '">';
                echo '<label>' . esc_html__('Shadow Type', 'quanto') . '</label>';
                echo '<select id="' . $this->field['id'] . '-shadow-type-select" data-placeholder="' . esc_html__('Shadow Type', 'quanto') . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[shadow-type]" class="redux-select-item redux-background-input redux-shadow-type ' . $this->field['class'] . '">';
                echo '<option></option>';
            ...
            if ($this->field['preview'] === true) {
                ...
                echo '<div class="clearfix"></div><div class="shadow-previewer" original-title="' . esc_html__('Shadow Preview', 'quanto') . '">';
        ...
        public function output() {
            ...
            if ( ! empty ( $this->value ) ){
                ...
                $opacity        = isset( $this->value['opacity'] )          ? $this->stripAlphas( $this->value['opacity'] )       : '1';
